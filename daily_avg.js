...
try {
    const scheculed_query=async()=>{
        // This query deletes the yesterdays uptime  and stores the same in yesterday_uptime table at the end of each day
        // Inserts or updates the uptime 
        ...
        `)
        // Saves previous day average power in daily_avg table.
